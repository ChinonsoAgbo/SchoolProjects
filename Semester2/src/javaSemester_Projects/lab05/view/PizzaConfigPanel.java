...
public class PizzaConfigPanel extends JPanel {
    ...
    private void initBild(){
        ...
        String imageSource = "src/de/hhn/prog2/lab05/view/images/HomePizza3.jpeg";
...
// Update the jLabelImage with the scaled image
    ...
    private void intiButtons(){
        ...
        jButtonBeenden = new JButton(new ImageIcon("src/de/hhn/prog2/lab05/view/images/xmark.png"));
        jButtonBeenden.setPreferredSize(new Dimension(100,50));
        jButtonFertig = new JButton(new ImageIcon("src/de/hhn/prog2/lab05/view/images/checkmark.png"));
